...
```{r partition, include=FALSE, message=FALSE}
set.seed(847)
...
```{r pca, echo=FALSE, fig.cap="FIGURE 1.1: Principal Component Results"}
...
```{r lda, echo=FALSE, fig.cap="FIGURE 2.1: Linear Discriminant Analysis"}
...
```{r rf, echo=FALSE, fig.cap="FIGURE 2.2: Random Forests", cache=TRUE}
